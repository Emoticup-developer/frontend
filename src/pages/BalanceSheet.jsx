                ...
                <div className="min-h-[404px] w-full">
                  ...
                  <div className="p-4 space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center">
                        <label
                          htmlFor="financial_statement_version"
                          className="w-64 text-left text-xs font-medium"
                        >
                          Statement Version
                        </label>
                        <input
                          type="text"
                          id="statement_version"
                          name="statement_version"
                          value={formData.statement_version}
                          onChange={handleChange}
                          className="w-60 h-5 border rounded px-1 py-0.5 text-xs bg-white"
                        />
                      </div>
                      <div className="flex items-center">
                        ...
                        <input
                          type="text"
                          id="account_group_range"
                          name="account_group_range"
                          value={formData.account_group_range}
                          onChange={handleChange}
                          className="w-60 h-5 border rounded px-1 py-0.5 text-xs bg-white"
                        />
                      </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="w-full border border-gray-300 rounded-sm bg-white p-2 text-xs leading-relaxed text-gray-800">
                      ...
                      revenues, costs, and expenses over a specific period. It
                      helps assess the financial performance of the organization
                      by showing net profit or loss. This report is crucial for
                      decision-making, financial planning, and evaluating
