                ...
                <div className="min-h-[404px] w-full">
                  ...
                  <div className="p-4">
                    ...
                    <div className="w-full border border-gray-300 rounded-sm bg-white p-2 text-xs leading-relaxed text-gray-800">
                      A Chart of Accounts (CoA) is a structured list of all
                      general ledger (G/L) accounts used by a company to record
                      financial transactions. It serves as the backbone of the
                      accounting system, enabling consistent classification of
