                  ...
                  <div className="p-4 space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center">
                        ...
                        <input
                          type="text"
                          id="accounting_principle"
                          name="accounting_principle"
                          value={formData.accounting_principle}
                          onChange={handleChange}
                          className="w-60 h-5 border rounded px-1 py-0.5 text-xs bg-white"
                        />
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <input
                          type="text"
                          id="start_of_validity"
                          name="start_of_validity"
                          value={formData.start_of_validity}
                          onChange={handleChange}
                          className="w-60 h-5 border rounded px-1 py-0.5 text-xs bg-white"
                        />
                      </div>
...
export default LedgerDefinitionFields;
