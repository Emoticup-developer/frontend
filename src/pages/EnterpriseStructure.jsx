          ...
          <div className="w-full bg-blue-100 border-t-2 border-b-2 border-[#031015]">
            <div className="flex justify-between items-center px-3">
              <div className="bg-amber-500 rounded-md bg-gradient-to-b from-amber-500 to-white">
                <h1 className="font-bold uppercase">ENTERPRISE STRUCTURE</h1>
              </div>
              <div>
                {/* Action Buttons */}
            ...
            <div className="w-full h-[360px] overflow-y-scroll">
              ...
              <div className="flex flex-col lg:flex-row lg:gap-8 lg:px-4 mb-5">
                ...
                <div className="flex flex-col gap-4 w-full lg:w-1/2">
                  <div className="flex items-center gap-2">
                    <label
                      htmlFor="company_enterprise"
                      className="w-[165px] h-7 px-2 py-0.5 text-sm font-semibold rounded-sm text-black"
                    >
                      Company (Enterprise)
                ...
                <div className="flex flex-col gap-4 w-full lg:w-1/2">
                  <div className="relative">
                    <div className="flex items-center gap-2">
                      <label
                        htmlFor="language"
                        className="w-[180px] h-7 px-2 py-0.5 text-sm font-semibold rounded-sm text-black"
                      >
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-center gap-2">
                      <label
                        htmlFor="currency"
                        className="w-[180px] h-7 px-2 py-0.5 text-sm font-semibold text-black"
                      >
                  ...
                  <div className="flex items-center gap-2">
                    <label
                      ...
                      className="w-[180px] h-7 px-2 py-0.5 text-sm font-semibold rounded-sm text-black"
                    >
                      Assign FSG<span className="text-amber-500"> *</span>
                    </label>
                    <input
                      type="text"
                      id="assign_fsg"
